...
const cardHeight = cardWidth * 1.2; // Aspect ratio 5:6

const ProgressCard = ({ sehajNumber, angNumber, progress }) => {
  const size = cardWidth * 0.5; // Reduced from 0.7 to 0.6 to allow for more padding
...
const styles = StyleSheet.create({
  ...
  textContainer: {
    alignItems: 'center',
    marginBottom: cardHeight * 0.10, // Increased from 0.05 to 0.08
  },
  sehajText: {
  ...
  progressContainer: {
    width: cardWidth * 0.6, // Reduced from 0.7 to 0.6
    height: cardWidth * 0.6, // Reduced from 0.7 to 0.6
    justifyContent: 'center',
    alignItems: 'center',
    marginBottom: cardHeight * 0.05, // Added bottom margin
  },
});
