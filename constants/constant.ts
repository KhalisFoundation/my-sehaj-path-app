...
export const Constants: Constant = {
  ...
  START_NEW: 'Start New',
  START_A_PATH_TITLE: 'Start new',
  CREATE_PATH_SUBTITLE: 'Start a Sehaj Path with your loved ones. Read together, stay connected.',
  PATH_NAME_INPUT_LABEL: 'Path name input',
  PATH_NAME_PLACEHOLDER: 'Path Name',
  CREATING: 'Creating…',
  ADD_MEMBERS_TITLE: 'Add members',
  ADD_MEMBERS_SUBTITLE: 'Invite others to join your path',
  SHARE_LINK: 'Share link',
  SHARE_LINK_DESCRIPTION: 'Anyone with the link can join',
  INVITE: 'Invite',
  INVITED: 'Added',
  ADDING: 'Adding…',
  ADD_MEMBERS_CONTINUE: 'Continue',
  CREATE_PATH_ADD_MEMBER_LOGIN_TITLE: 'Sign in to invite others',
  CREATE_PATH_ADD_MEMBER_LOGIN_MESSAGE:
    'Sign in to share this path with other readers and invite them to read with you.',
  ENABLE_IN_APP_MEMBER_ADD: false,
  ONLY_MEMBER: 'I am the only member',
  SHARE_LINK_TO_ADD_MEMBERS: 'Share the link to add members.',
  INVITE_MEMBER_TITLE: 'Invite a member',
  INVITE_ACCEPT_EYEBROW: 'You’ve been invited to read',
  INVITE_MEMBER_COUNT: 'Number of users: {count}',
  JOIN_NOW: 'Join Now',
  OPEN_PATH: 'Go To Path',
  ALREADY_PATH_MEMBER: 'You are already a member of this Sehaj Path.',
  EXISTING_ACTIVE_LINKS: 'Existing active links',
  EXISTING_ACTIVE_LINK: 'Existing active link',
  ACTIVE_INVITE_LINK_UNAVAILABLE:
    'This older link cannot be copied. Create a new link to share it across all admins.',
  ...
  INVITE_LINK_EXPIRED: 'This link has expired. Create a new one to share this path.',
  INVITE_LINK_DIRECT_JOIN_HINT: 'Anyone with this link can join this path directly.',
  CREATE_LINK_HINT: 'Choose an expiry, then create a link to invite members.',
  LOADING_INVITE_LINK: 'Loading invite link…',
  INVITE_GO_ONLINE_TO_SHARE: 'Please go online to share the link.',
  INVITE_SIGN_IN_REQUIRED: 'Please sign in to share the link.',
  INVITE_SIGN_IN_TITLE: 'Sign in to share your link',
  EXPIRES: 'Expires',
  COPY_LINK: 'Copy Link',
  COPIED: 'Copied',
  SHARE_INVITE_LINK: 'Share invite link',
  SHARING_OPTIONS: 'Sharing options',
  PATH_NOT_SHARED_YET: 'This path has not been shared yet.',
  ADD_MEMBERS_SIGN_IN_REQUIRED: 'Sign in and connect to the internet before adding members.',
  DELETE_SEHAJ_PATH: 'Delete Sehaj Path',
  PATH_DELETED: 'Path deleted.',
  DELETE_SEHAJ_PATH_TITLE: 'Delete this path?',
  DELETE_SEHAJ_PATH_FAILED_TITLE: 'Could not delete path',
  DELETE_SEHAJ_PATH_MESSAGE_BEFORE: 'Your saved progress for ',
  DELETE_SEHAJ_PATH_MESSAGE_AFTER: ' will be deleted from your Sehaj Paths.',
  DELETE: 'Delete',
  DELETING: 'Deleting…',
  LEAVE_PATH: 'Leave path',
  LEAVE_PATH_TITLE: 'Leave path?',
  LEAVE_PATH_MESSAGE: 'You will stop seeing this shared reading path.',
  LEAVE_PATH_ADMIN_TITLE: 'Make an admin first',
  LEAVE_PATH_ADMIN_MESSAGE: 'You cannot leave until you make someone else an admin.',
  ...
  ADD_TURN: 'Add turn',
  ADD_TURN_AT_TIME: 'Add turn at this time',
  ADD_TURN_TITLE: 'Add a turn',
  EDIT_TURN_TITLE: 'Edit turn',
  EDIT_TURN: 'Edit turn',
  SAVE_TURN_CHANGES: 'Save changes',
  NO_TURNS_YET: 'No turns yet',
  NO_UPCOMING_SLOTS: 'No upcoming slots.',
  LOADING_TURNS: 'Loading turns…',
  RETRY_TURNS: 'Retry loading turns',
  ADD_TURN_TO_CREATE_SCHEDULE: 'Add turns to create the reading schedule.',
  FOLLOW_ALONG: 'Follow along',
  READ_ALONG: 'Read along',
  TAKE_YOUR_TURN: 'Take your turn',
  TAKEOVER_COUNTDOWN_SECONDS: 5,
  READER_LEFT_TITLE: 'Reader has left',
  READER_START_ERROR_TITLE: 'Unable to start reading',
  READER_LEFT_MESSAGE:
    'The reader has disconnected. Their reading is paused while we wait for them to reconnect. We will resume automatically if they return.',
  TAKEOVER_SAVE_HINT: 'Long tap a panktee to save for next reader',
  FIRST_FOUR_PANKTEE_OF_CURRENT_ANG: 'First 4 panktee of the current Ang being read by ',
  YOU: 'You',
  DATE: 'Date',
  START_TIME: 'Start time',
  DURATION: 'Duration',
  SELECT_START_TIME: 'Select a start time',
  SELECTED_TIME_AVAILABLE: 'This time is available',
  SELECTED_TIME_PAST: 'Select a time that has not passed.',
  SELECTED_TIME_TOO_SOON: 'Choose a time at least {minutes} minutes from now.',
  SELECTED_TIME_NEXT_DAY: 'This turn would continue into the next day.',
  SELECTED_TIME_OVERLAP: 'This time overlaps another turn.',
  BOOKING: 'Booking…',
  EDITING: 'Editing…',
  COMPLETE_10_ANGS:
  ...
  LOGIN_REQUIRED_MESSAGE: 'Please sign in to view members and reading turns.',
  LOGOUT: 'Logout',
  ...
  SHARED_PATH_OFFLINE_TITLE: 'Internet connection required',
  SHARED_PATH_OFFLINE_MESSAGE:
    'Shared paths need an internet connection for live reading, turns, and member updates.',
  ...
  RETRY_PROGRESS: 'Retry loading progress',
