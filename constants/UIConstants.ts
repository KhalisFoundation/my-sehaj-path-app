...
export const UIConstants: UIConstant = {
  ...
  PADDING: 12,
  RHYTHM: 12,
  DRAWER_PANEL_BACKGROUND: '#F5F5F5',
  DRAWER_HEADER_BACKGROUND: '#11336A',
  DRAWER_LOGO_TILE_BACKGROUND: '#FFFFFF20',
  DRAWER_HEADER_TITLE_COLOR: '#FFFFFF',
  DRAWER_MENU_ITEM_COLOR: '#2C3E50',
  DRAWER_DONATE_ACCENT: '#F39C12',
};
